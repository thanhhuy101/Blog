...
export default function Navigation() {
  ...
  return (
    // <div className="container mx-auto px-44 py-3">
    //   <div className="flex items-center justify-between rounded-full bg-white px-16 py-3 shadow-md">
    //     {/* Logo */}
    ...
    //     {/* Navigation */}
    //     <div
    //       className={`items-center space-x-8 md:flex ${isMenuOpen ? "block" : "hidden"}`}
    //     >
    //       <Link
    //         href="/ve-chung-toi"
    ...
    //     {/* Right side - Language and CTA button */}
    ...
    //       {/* CTA Button */}
    //       <button className="flex items-center rounded-full bg-green-500 px-4 py-2 text-sm font-medium text-white shadow-sm">
    //         <span>Trở Thành Khách Hàng</span>
    //         <div className="ml-2 rounded-full bg- p-1">
    //           <svg
    //             xmlns="http://www.w3.org/2000/svg"
